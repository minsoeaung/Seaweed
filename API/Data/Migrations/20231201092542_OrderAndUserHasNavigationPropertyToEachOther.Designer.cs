...
namespace API.Data.Migrations
{
    ...
    [Migration("20231201092542_OrderAndUserHasNavigationPropertyToEachOther")]
    partial class OrderAndUserHasNavigationPropertyToEachOther
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Entities.OrderAddress", b =>
                {
                    ...
                    b.HasOne("API.Entities.Order", null)
                        ...
                        .HasForeignKey("API.Entities.OrderAddress", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
